...
function addView(container, template, data, callback, replace, prepend) {
...
function addViews(container, templates, outerCallback) {

	function createCallback(template, data, callback) {
		return function() {
			addView(container, template, data, callback, false, false); 
		}
	}
...
function setupPage(templates, outerCallback) {

	var page = {

		onReady : function() {
			
			addViews(viewContainer, templates, outerCallback);
